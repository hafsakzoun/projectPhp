...
@endif
        ...
        <form method="post" action ="{{url('update-product')}}">
            ...
            <div class="md-3">
              ...
              <input type="text" class="form-control" name="libelle" placeholder="Entrer le nom du produit"  value="{{$data->libelle}}"><br>
              @error('libelle')
            ...
            <div class="md-3">
              ...
              <input type="text" class="form-control" name="description" placeholder="Decrire le produit"  value="{{$data->description}}"><br>
              @error('libelle')
              <div class="alert alert-danger" style="color:red">
                {{$message}}
              </div>
             ...
             <div class="md-3">
              ...
              <input type="text" class="form-control" name="qnt" placeholder="Entrer la quantite" value="{{$data->quantite}}"><br>
              @error('libelle')
              <div class="alert alert-danger" style="color:red">
                {{$message}}
              </div>
            ...
            <div class="md-3">
              ...
              <input type="text" class="form-control" name="price" placeholder="Entrer prix du produit" value="{{$data->price}}" ><br>
              @error('libelle')
              <div class="alert alert-danger" style="color:red">
                {{$message}}
              </div>
